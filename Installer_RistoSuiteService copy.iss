...
Source: "C:\COMPILATORE\RistoSuiteCompilatore\sfondo_ristosuite.bmp"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\COMPILATORE\RistoSuiteCompilatore\{#MyKioskExeName}"; DestDir: "{app}"; Flags: ignoreversion
